...
public class ModTags {
    ...
    private static TagKey<Block> modBlockTag(String tagName) {
        return ModTags.blockTag(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, tagName));
    }

    private static TagKey<Item> modItemTag(String tagName) {
        return ModTags.itemTag(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, tagName));
    }
}
