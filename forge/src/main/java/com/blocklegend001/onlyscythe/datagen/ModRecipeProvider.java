...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    public void baseScytheRecipe(RecipeOutput output, ItemLike ingredient, Item result) {
        shaped(RecipeCategory.TOOLS, result)
                ...
                .pattern("  S")
                .pattern("  S")
                .unlockedBy("has_" + ingredient.asItem().builtInRegistryHolder().key().identifier().getPath(), has(ingredient))
                .save(output);
    }
    ...
    public void baseSmithingRecipe(RecipeOutput output, Item base, Item addition, Item result) {
        SmithingTransformRecipeBuilder
                ...
                .save(output, String.valueOf(Identifier.fromNamespaceAndPath("onlyscythe", result.getDescriptionId().replace("item.onlyscythe.", "") + "_smithing")));
    }
